...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        Obj = {
            createInputWithoutRequired:function(id,label,type){
                let show_type;
                if(type=='number'){
                    show_type = type
                }else if(type=='email'){
                ...
                return `
                    <div class="col-md-3">
                            <div class="form-floating mb-2">
                                <input class="form-control" id="${id}" type="${show_type}" placeholder="${label}">
            ...
            dynamicDropdownSub: function ($select, responseData, main_id=null) {
