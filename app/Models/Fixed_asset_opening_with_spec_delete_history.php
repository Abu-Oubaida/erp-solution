...
class Fixed_asset_opening_with_spec_delete_history extends Model
{
    use HasFactory;
    protected $fillable = ['old_id', 'date', 'opening_asset_id', 'references', 'company_id', 'asset_id', 'spec_id', 'rate', 'qty', 'purpose', 'remarks', 'created_by', 'updated_by', 'old_created_at', 'old_updated_at', 'deleted_by'];
