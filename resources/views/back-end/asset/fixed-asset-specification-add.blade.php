                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-floating mb-2">
                                        <input class="form-control form-control-sm" id="recourse_code" list="recourse_code_list" name="recourse_code" type="text" placeholder="Enter Recourse Code or Name" value="{{Request::get('fid')}}" required/>
                                        <datalist id="recourse_code_list">
                                            @if(count($fixed_assets))
                                                @foreach($fixed_assets as $fx)
                                                    <option value="{!! $fx->recourse_code !!}">{!! $fx->materials_name !!}</option>
                ...
                <div class="card mb-2">
                    <div class="card-body">
                        <form action="{!! route('fixed.asset.specification') !!}" method="post">
                            ...
                            @method('post')
                            <div class="row">
                                <input type="hidden" name="recourse_code" value="{!! Request::get('fid') !!}">
                                <div class="col-md-8">
                                    <div class="form-floating mb-2">
                                ...
                                <div class="col-md-12">
                                    <span><strong>Recourse Code:</strong> {!! Request::get('fid') !!}</span>
...
{{--                                    <tr class="{!! (isset($fixed_asset) && $fas->id == $fixed_asset->id)?'text-primary':'' !!}">--}}
                                    <tr>
                                        ...
                                        <td>{!! (isset($fas->createdBy->name))?$fas->createdBy->name:'-' !!}</td>
                                        <td>{!! (isset($fas->updatdBy->name))?$fas->updatdBy->name:'-' !!}</td>
