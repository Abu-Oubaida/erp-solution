...
<div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item">
            <a href="{{route('company.setup')}}" class="text-capitalize text-chl text-decoration-none">Company Setup</a>
        </li>
        <li class="breadcrumb-item">
        ...
        <div class="col-md-6">
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{!! route('edit.company.type',["companyTypeID"=>\Illuminate\Support\Facades\Crypt::encryptString($editID->id)]) !!}" method="POST">
                        @csrf
                        @method('put')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="company-type-title" name="company_type_title" required="required" placeholder="Company Name" value="{!! $editID->company_type_title !!}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <select name="company_type_status" id="company_type_status" class="form-control">
                                        ...
                                        <option value="0" @if($editID->status == 0) selected @endif>Inactive</option>
                                    </select>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="description" name="description"> {!! $editID->remarks !!}</textarea>
