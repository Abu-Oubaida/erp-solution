        ...
        <div class="col-md-12" id="company_section">
            <div class="card mb-4">
                <div class="card-header pt-3">
                    <div class="row">
                        <div class="col-md-8">
                            <h5><i class="fas fa-plus"></i> Add New Company</h5>
                        </div>
                        <div class="col-md-4">
                            <a href="{!! route('add.company.type') !!}" class="btn btn-sm btn-outline-primary float-start"><i class="fas fa-solid fa-plus"></i> Add Company Type</a>
                            <a href="{!! route('company.list') !!}" class="btn btn-sm btn-outline-info float-end"><i class="fas fa-list"></i> Company List</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
