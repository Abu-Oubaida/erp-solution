                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        @endif
                            ...
                            <button class="btn btn-primary btn-chl" id="btnNavbarSearch" type="button"> Forward <i class="fas fa-paper-plane"></i></button>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="float-end">
                    ...
                    <div class="col-md-12">
                        ...
                        @else
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="row">
                                        <strong >Generated By: <span class="badge bg-success">{!! $com->name !!}</span></strong>
