<div class="row">
    <div id="" class="">
        @if(auth()->user()->hasPermission('share_archive_data_individual'))
            <button class="btn btn-outline-success float-end" href="" ref="{!! \Illuminate\Support\Facades\Crypt::encryptString($document->id) !!}" onclick="return Obj.fileSharingModal(this)" title="Share Document"><i class="fa-solid fa-envelope"></i> Email Document</button>
        @endif
        <div class="col-md-12">
