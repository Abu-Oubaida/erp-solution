...
<div class="row">
    <div class="col-md-6 mb-2">
        ...
        <button class="btn btn-outline-danger btn-sm" name="submit_selected" type="submit" value="delete" onclick="return SalesSetting.deleteSalesSettingMultiple('/delete-sales-lead-profession-multiple')"> <i class="fas fa-trash"></i> Delete Selected</button>
    </div>
</div>
