...
<div class="row">
    <div class="col-md-6 mb-2">
        ...
        <button class="btn btn-outline-danger btn-sm" name="submit_selected" type="submit" value="delete" onclick="return SalesSetting.deleteTypeMultiple()"> <i class="fas fa-trash"></i> Delete Selected</button>
    </div>
</div>
            ...
            @foreach ($rows as $key => $row)
                <tr>
                    ...
                    <td>
                        ...
                        <button class="text-success" title="Edit" onclick="return SalesSetting.salesSubTableEdit('sales_lead_apartment_type','',{{ $row->id}})"><i class='fas fa-edit'></i></button>
