    ...
    <div class="card-body" id="commonSlot_for_multiple_step">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <select class="text-capitalize form-control associate_dropdown" id="associate_id" name="associate">
                    <option value="">Pick options...</option>
                    @if (!empty($salesEmployeeEntries))
                        @foreach ($salesEmployeeEntries as $e)
                            <option value="{{ $e->user->id }}" @if (Auth::user()->id == $e->user->id) selected @endif>
                                {{ $e->user->employee_id }}
                                ({{ $e->user->name }})
                            </option>
                        @endforeach
            ...
            <div class="col-md-4 mb-1">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            <input class="form-control" id="email_1" type="email" placeholder="Enter Email 2"
                                @if (isset($getLead->extraEmails) && count($getLead->extraEmails)) value="{{ $getLead->extraEmails[0]->email }}" @endif />
                        </div>
                    </div>
                    @if (!$getLead)
                        <div class="col-12 mt-1">
            ...
            <div class="col-md-4">
                ...
                <div class="mb-5">
                    <textarea type="text" class="form-control" id="notes" name="notes" placeholder="Notes" style="height: 37px;">{{ $getLead->notes ?? null }}</textarea>
                </div>
            </div>
            <div class="col-md-8">
