        ...
        <div class="nav">
            ...
            <group4>
                ...
                @if(auth()->user()->hasPermission('user_management'))
                    ...
                    <subgroup1>
                        @if(Route::currentRouteName() == 'add.user'|| Route::currentRouteName() == 'user.list' || Route::currentRouteName() == 'user.single.view' || Route::currentRouteName() == 'add.department'|| Route::currentRouteName() == 'user.edit' || Route::currentRouteName() == 'add.designation'|| Route::currentRouteName() == 'add.blood.group'|| Route::currentRouteName() == 'add.branch'|| Route::currentRouteName() == 'edit.branch' || Route::currentRouteName() == 'blood.group.list' || Route::currentRouteName() == 'branch.list' || Route::currentRouteName() == 'branch.type.list' || Route::currentRouteName() == 'add.branch.type' || Route::currentRouteName() == 'edit.branch.type' || Route::currentRouteName() == 'edit.department')
