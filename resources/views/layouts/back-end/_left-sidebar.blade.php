<nav class="sb-sidenav accordion " id="sidenavAccordion" style="background: #f0ffffde;">
    <div class="sb-sidenav-menu">
        ...
        @endif
            ...
            @if(Route::currentRouteName() == 'add.complain' || Route::currentRouteName() == 'individual.list.complain'|| Route::currentRouteName() == 'my.list.complain'|| Route::currentRouteName() == 'single.view.complain' || Route::currentRouteName() == 'edit.me.complain' || Route::currentRouteName() == 'my.trash.list.complain' || Route::currentRouteName() == 'departmental.list.complain')
            ...
            @endif
                ...
                @if(Route::currentRouteName() == 'my.trash.list.complain')
                    <a class="nav-link" href="{{route("my.trash.list.complain")}}"><div class="sb-nav-link-icon"><i class="fas fa-trash"></i></div> My Trash List</a>
                @else
                    <a class="nav-link text-chl" href="{{route("my.trash.list.complain")}}"><div class="sb-nav-link-icon"><i class="fas fa-trash"></i></div> My Trash List</a>
                @endif
                </nav>
            </div>
