...
{{--            <div>--}}
{{--                <a href="/">--}}
{{--                    <a href="{{route('root')}}" class="w-20 h-20 fill-current text-gray-500"><img src="{{url("image/logo/default/icon/360.png")}}" alt="{{str_replace('-', '-', config('app.name'))}}" class="img-fluid" width="10%"></a>--}}
{{--                    <x-application-logo  />--}}
{{--                </a>--}}
{{--            </div>--}}
