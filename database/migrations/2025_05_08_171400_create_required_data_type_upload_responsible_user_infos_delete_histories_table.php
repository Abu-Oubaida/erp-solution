...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('req_data_type_upload_res_user_delete_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('req_data_type_upload_res_user_delete_histories');
    }
};
