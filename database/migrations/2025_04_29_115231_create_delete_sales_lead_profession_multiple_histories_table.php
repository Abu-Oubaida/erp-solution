...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('delete_sales_lead_profession_multiple_histories', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('delete_sales_lead_profession_multiple_histories');
    }
};
