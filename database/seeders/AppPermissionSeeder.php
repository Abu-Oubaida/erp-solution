...
class AppPermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ['id' => '104','parent_id' => '27','name' => 'company_directory_permission','is_parent' => NULL,'display_name' => 'Delete Department','description' => 'Delete Department','created_at' => date(now()),'updated_at' => null],
        ];
